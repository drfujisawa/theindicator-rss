...
RECOVERY_FILE = "indicator_npr_audio_recovery.json"
VALIDATION_FILE = "indicator_npr_audio_validation.json"
PLAYER_FILE = "indicator_npr_player_resolution.json"

OUTPUT_FILE = "indicator_npr_audio_mapping.json"
