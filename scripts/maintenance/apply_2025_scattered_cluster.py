#!/usr/bin/env python3
"""Atomically apply the reviewed scattered 2025 repair."""
...
from scripts.analysis.stage_2025_scattered_cluster import EPISODES
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_2025_scattered_cluster_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_2025_scattered_cluster_application_report.json"
...
def apply(repo_root=REPO_ROOT, stage_dir=None, staging_report_path=None):
    values = {
        ...
        "BATCH_LABEL": "2025-scattered-cluster",
    }
