#!/usr/bin/env python3
"""Atomically apply the reviewed scattered 2024 five-episode repair."""
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_2024_scattered_cluster_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_2024_scattered_cluster_application_report.json"
REQUIRED_IDS = {"1197963467", "1197964551", "1197964709", "1197965006", "1197967993"}
...
def apply(repo_root=REPO_ROOT, stage_dir=None, staging_report_path=None):
    values = {
        ...
        "BATCH_LABEL": "2024-scattered-cluster",
    }
