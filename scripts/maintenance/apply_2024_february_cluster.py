#!/usr/bin/env python3
"""Atomically apply the reviewed February 2024 four-episode repair."""
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_2024_february_cluster_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_2024_february_cluster_application_report.json"
REQUIRED_IDS = {"1197961569", "1197961640", "1197961671", "1197961679"}
...
def apply(repo_root=REPO_ROOT, stage_dir=None, staging_report_path=None):
    values = {
        ...
        "BATCH_LABEL": "2024-february-cluster",
    }
