#!/usr/bin/env python3
"""Atomically apply the reviewed four-episode ranked batch 3 staging set."""
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_remaining_ranked_batch3_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_remaining_ranked_batch3_application_report.json"
REQUIRED_IDS = {"692150886", "696426869", "698360321", "705944777"}
