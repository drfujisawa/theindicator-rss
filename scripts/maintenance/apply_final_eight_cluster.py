#!/usr/bin/env python3
"""Atomically apply the reviewed final eight-episode repair."""
...
from scripts.analysis.stage_final_eight_cluster import EPISODES
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_final_eight_cluster_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_final_eight_cluster_application_report.json"
...
def apply(repo_root=REPO_ROOT, stage_dir=None, staging_report_path=None):
    values = {
        ...
        "BATCH_LABEL": "final-eight-cluster",
    }
