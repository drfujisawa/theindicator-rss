#!/usr/bin/env python3
"""Atomically apply the reviewed February 7-16, 2024 repair."""
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_2024_february_mid_cluster_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_2024_february_mid_cluster_application_report.json"
REQUIRED_IDS = {
    "1197961691", "1197961699", "1197961749", "1197961810",
    "1197961826", "1197961858", "1197961870", "1197961990",
}
...
def apply(repo_root=REPO_ROOT, stage_dir=None, staging_report_path=None):
    values = {
        ...
        "BATCH_LABEL": "2024-february-mid-cluster",
    }
