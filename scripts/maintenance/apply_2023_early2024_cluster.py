#!/usr/bin/env python3
"""Atomically apply the reviewed 2023/early-2024 repair."""
...
from scripts.analysis.stage_2023_early2024_cluster import EPISODES
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_2023_early2024_cluster_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_2023_early2024_cluster_application_report.json"
...
def apply(repo_root=REPO_ROOT, stage_dir=None, staging_report_path=None):
    values = {
        ...
        "BATCH_LABEL": "2023-early2024-cluster",
    }
