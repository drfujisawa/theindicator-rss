#!/usr/bin/env python3
"""Atomically apply the reviewed eleven-episode ranked batch 5 staging set."""
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_remaining_ranked_batch5_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_remaining_ranked_batch5_application_report.json"
REQUIRED_IDS = {
