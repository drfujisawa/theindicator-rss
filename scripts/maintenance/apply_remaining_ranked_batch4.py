#!/usr/bin/env python3
"""Atomically apply the reviewed six-episode ranked batch 4 staging set."""
...
DEFAULT_STAGE_DIR = REPO_ROOT / "work/remaining-ranked-batch4-staging"
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_remaining_ranked_batch4_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_remaining_ranked_batch4_application_report.json"
REQUIRED_IDS = {"669768474", "674297137", "678327898", "683323818", "690508923", "691782578"}
