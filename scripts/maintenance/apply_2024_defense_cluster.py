#!/usr/bin/env python3
"""Atomically apply the reviewed 2024 defense-cluster repair."""
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_2024_defense_cluster_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_2024_defense_cluster_application_report.json"
REQUIRED_IDS = {"1197961507", "1197961524"}
...
def apply(repo_root=REPO_ROOT, stage_dir=None, staging_report_path=None):
    values = {
        ...
        "BATCH_LABEL": "2024-defense-cluster",
    }
