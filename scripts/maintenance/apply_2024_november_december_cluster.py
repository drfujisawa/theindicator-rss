#!/usr/bin/env python3
"""Atomically apply the reviewed November-December 2024 repair."""
...
from scripts.analysis.stage_2024_november_december_cluster import EPISODES
...
STAGING_REPORT = REPO_ROOT / "data/audits/indicator_2024_november_december_cluster_staging_report.json"
APPLICATION_REPORT = REPO_ROOT / "data/audits/indicator_2024_november_december_cluster_application_report.json"
...
def apply(repo_root=REPO_ROOT, stage_dir=None, staging_report_path=None):
    values = {
        ...
        "BATCH_LABEL": "2024-november-december-cluster",
    }
